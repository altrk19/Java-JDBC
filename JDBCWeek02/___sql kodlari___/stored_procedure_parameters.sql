...
CREATE DEFINER=`admin`@`localhost` PROCEDURE `get_count_for_department`(IN the_department VARCHAR(64), OUT the_count INT)
BEGIN
...
CREATE DEFINER=`admin`@`localhost` PROCEDURE `get_employees_for_department`(IN the_department VARCHAR(64))
BEGIN
...
CREATE DEFINER=`admin`@`localhost` PROCEDURE `greet_the_department`(INOUT department VARCHAR(64))
BEGIN
...
CREATE DEFINER=`admin`@`localhost` PROCEDURE `increase_salaries_for_department`(IN the_department VARCHAR(64), IN increase_amount DECIMAL(10,2))
BEGIN
